...
> Modified from [react-sticky](https://github.com/captivationsoftware/react-sticky) repository, refactored with typescript and react hooks.
...
```sh
npm install @jonny1994/react-sticky

# or

yarn add @jonny1994/react-sticky
```
